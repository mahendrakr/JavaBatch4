 ...
 * college code:-
 * total branchs :-
 * numbers of total students in college:-
 * no. of total labs:-
 *  properties:- study,practicals,learnings
 *  
 *  behaviors of college-
 *  study,pracicals,learning
...
public class College {
	...
	void study() {System.out.println("college provids study material");}
	void practicals () {System.out.println("also practicals");}
	void learnings () {System.out.println("college provide best learning way");}
